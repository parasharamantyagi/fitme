								...
								<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
									<div id="myTabContent1" class="tab-content">
										<div class="product-tab-list tab-pane fade active in" id="single-tab1">
											<img src="{{url(product_first_image($user_product->product_field->product->app_product_images))}}" alt="" style="height: 200px;width: 375px;" />
										</div>
									</div>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
									<div class="single-product-details res-pro-tb">
										<h1>{{$user_product->product_field->product->Bra_name}}</h1>
										<div class="single-pro-price">
											<span class="single-regular">{{my_currecy($user_product->product_field->product->price)}}</span>
										</div>
										<div class="single-pro-size">
											<h6>Size</h6>
											<span>{{$user_product->product_field->product->Band_size_ID}}</span>
										</div>
